...
public class RobotContainer {
  ...
  public static JoystickButton abutton2;
  ...
  public RobotContainer() {
    ...
    abutton = new JoystickButton(joystick, Constants.ABUTTON);
    abutton2 = new JoystickButton(joystick2, Constants.ABUTTON);
  ...
  private void configureButtonBindings() {
    ...
    abutton.whileActiveContinuous(new LimelightRotate(mecanumSubsystem));
    abutton2.whileActiveContinuous(new LimelightShooter(shooter));
